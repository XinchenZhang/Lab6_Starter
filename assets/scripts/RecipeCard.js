class RecipeCard extends HTMLElement {
  ...
  set data(data) {
    ...
    nav.href = searchForKey(data, 'url');
    nav.innerHTML = searchForKey(data, 'headline');
    title1.appendChild(nav);
    ...
    ingredient.innerText = createIngredientList(recipeIngredient);
