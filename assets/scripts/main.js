...
const recipes = [
  ...
  'assets/recipes/turkeyBolognese.json',
  'assets/recipes/turkeyLasagna.json',
  'assets/recipes/bbqRibs.json'
];
    ...
    for(let i = 0; i < recipes.length; i++){
      fetch(recipes[i])
        ...
        .then(data => {
          ...
          if (recipes.length == Object.keys(recipeData).length) resolve(true);
        })
    }
  });
}
